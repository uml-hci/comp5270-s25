...
By default, all members of a group will receive the same grade on the presentations, interim deliverables, final report, and final presentation portions of the project (worth 950% of the project grade, all together). Each written deliverable should be submitted to Blackboard once per team, not once per person.

The teammate survey will be graded individually and used in determining how many of the remaining 10% each person will receive.
